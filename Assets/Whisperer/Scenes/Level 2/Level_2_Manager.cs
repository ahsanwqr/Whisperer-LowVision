...
namespace Whisperer
{
    public class Level_2_Manager : LevelManager
    {
        ...
        [SerializeField] private Transform _beaNeckJoint;
        ...
        [SerializeField] private HeroPlant _tablePlant;
        [SerializeField] private Animator _waterPlantAnimator;
        [SerializeField] private Animator _chestPlantAnimator;
        [SerializeField] private TreasureChest _chest;
        [SerializeField] private WaterFaucet _water;
        [SerializeField] private List<Listenable> _actionItems;
        ...
        private IEnumerator _noticeRoutine;
        ...
        private IEnumerator LevelRoutine()
        {
            ...
            _chalkBoard.FadeToNext(2);
            for (var i = 1; i <= 3; i++) _checkmarks[i].SetChecked(false);
            ...
            yield return new WaitForSeconds(
                _beaSpeech.SetSpeech("Oh - but how...?", 4, "Bea_Yawn"));
