...
{
    public override string Name => "OculusSpatializerReflection";

    public override string Description => "Reflection parameters for Oculus Spatializer";

    public override string Vendor => "Oculus";
