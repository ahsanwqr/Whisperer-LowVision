...
namespace Whisperer
{
    ...
    {
        public List<Progress> ActiveProgress = new();

        private void Update()
        {
            for (var i = ActiveProgress.Count - 1; i >= 0; i--) ActiveProgress[i].Update(Time.deltaTime);
        }
    }
    ...
    public class Progress
    {
        ...
        /// </summary>
        public float Value => _progress;

        /// <summary>
        ///     Is playback paused?
        /// </summary>
        public bool Paused => _direction == 0;
        ...
        /// </summary>
        public bool Playing => _direction != 0;
        ...
        /// <summary>
        ///     Start progress toward 1 from the current progress value, scaled such that 0->1 is completed in
        ...
        /// <summary>
        ///     Start progress toward 0 from the current progress value, scaled such that 1->0 is completed in
        ///     <paramref name="duration" /> (seconds).
        /// </summary>
        /// <param name="duration"></param>
        ...
        /// <summary>
        ///     Stop playback and set progress to starting value based on current direction (i.e. if forward, progress will set to
        ///     0).
        /// </summary>
        public void Reset()
        {
            var direction = Paused ? _lastDirection : _direction;
