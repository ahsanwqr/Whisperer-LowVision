...
#if !UNITY_5
    private static readonly int numFOAChannels = 4; // we are only dealing with 1st order Ambisonics at this time
    private static readonly int paramAmbiStat = 6; // use this to return internal Ambisonic status
